...
// Todo: buat ke component tersendiri
      ...
      <div className="flex flex-col justify-between ml-4 py-6">
        <div>
          <h2 className="font-medium text-lg w-4/5">
            Product sdfg sdfghds sfd Title lorem ipsum kemana kesum kjgckhgc
            kghcjhgc
          </h2>
        ...
        <div>
          <button className="bg-black text-white px-2 w-8 h-8 text-2xl">
            -
          </button>
